    ...
    */
    ...
    'custom' => [
        ...
        'password' => [
            ...
            'max' => 'Password must not be greater than 255 characters',
        ...
        'two_factor_code' => [
            ...
            'numeric' => 'Two factor code must be a number',
            'digits' => 'Two factor code must be 6 digits',
        ],
        'g-recaptcha-response' => [
            'required' => 'Recaptcha is required',
            'captcha' => 'Recaptcha is invalid',
        ],
    ],
